...
Standard ZRS and Standard LRS snapshots are priced identically, regardless of the underlying redundancy configuration.
This pricing consistency applies to both incremental and full snapshot types.
