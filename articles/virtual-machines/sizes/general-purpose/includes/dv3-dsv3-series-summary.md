...
# Customer intent: As a cloud architect, I want to review the specifications of the Dv3 and Dsv3-series virtual machine sizes, so that I can choose the appropriate configurations for optimizing general purpose workloads in my organization.
---
