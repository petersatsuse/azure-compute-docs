...
# Customer intent: "As a cloud architect, I want to review the specifications of the Dv4 and Dsv4-series virtual machine sizes, so that I can select the most suitable options for optimizing general-purpose workloads."
---
