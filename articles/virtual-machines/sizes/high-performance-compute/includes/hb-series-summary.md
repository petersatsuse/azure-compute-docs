...
# Customer intent: As a software engineer, I want to assess the capabilities of HB-series virtual machines, so that I can determine if they meet the memory bandwidth requirements for my high-performance computing applications.
---
