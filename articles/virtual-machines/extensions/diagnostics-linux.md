...
>
> As an alternative to storage, you should send data to a table with the [Auxiliary plan](/azure/azure-monitor/agents/logs/data-platform-logs.md#table-plans) in your Log Analytics workspace for cost-effective logging.
>
