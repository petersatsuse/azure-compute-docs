...
You can expand [NVMe](../nvme-overview.md) Ultra or Premium SSD v2 disks without downtime in all regions that support either of those disk types, except the following: 
